...
public class AppRater {
    ...
    private static String KEY_OPT_OUT = "rta_opt_out";
    ...
    public static void showRateDialog(final Context context) {
        ...
        builder.setNegativeButton(R.string.rta_dialog_ok,
                new OnClickListener() {
                    @Override
        ...
        builder.setNeutralButton(R.string.rta_dialog_cancel,
                new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
        ...
        builder.setPositiveButton(R.string.rta_dialog_no,
                new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        setOptOut(context, true);
